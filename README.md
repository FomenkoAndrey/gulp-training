...
[Инструкция для замены терминала по умолчанию в VSCode (для Windows)](./CMD.md){:target="\_blank" rel="noopener"}.

> Работа с консолью **PowerShell** приводит к ошибкам сценариев.  
> Как минимум, используйте **Cmd** в качестве терминала VSCode.  
> Вместо **cmd** можно воспользоваться GitBush или Cmder.  
> [Инструкция по интеграции **Cmder** и **GitBush** в VSCode](https://dev.to/andrewriveradev/how-to-setup-cmder-in-vscode-in-2021-3nkc).
